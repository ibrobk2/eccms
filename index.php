...
<body>
    ...
    <div id="faq">
        <div class="faq-content">
            ...
            <div class="panel">
                <p>Yes, this website is in control of the Nigerian government and is a legit one.</p>
            </div>
            ...
            <button class="accordion">Are Lawyers on this Platform Cheap?</button>
            <div class="panel">
                <p>Yes, The Lawyers in this system are very cheap to hire.</p>
            </div>

            <button class="accordion">Can I Register Multiple Account on the Platform</button>
            <div class="panel">
                <p>No, you can not register multiple account with the same e-mail address as the email is used to authenticate each user in the system.</p>
            </div>
    ...
    <div class="contact-section">
        <h3 style="text-align:center; font-family:sans-serif">Contact Form</h3>
    </div>
    <div id="contact">
    ...
    <footer>
        <p style="text-align: center; font-weight:bold;">Copyright &copy; 2023 Department of Computer Science, Al-Qalam University, Katsina.</p>
    </footer>
    ...
    function redirect() {
        ...
        window.location.href =
            "https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&to=mohazakari18@gmail.com&su=Contact+by+" +
            fname + "+" + lname +
