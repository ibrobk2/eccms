...
$lawyer_id = intval($_SESSION['lawyer_id']);
// $stmt = $con->query("SELECT lawyer_first_name, lawyer_last_name, lawyer_email, lawyer_phone_no, lawyer_city, lawyer_address, lawyer_rating, specialization, image_type from lawyer_login WHERE lawyer_id = $lawyer_id");
$stmt = $con->query("SELECT * FROM lawyer_login WHERE lawyer_id = $lawyer_id");
...
if($stmt){
    ...
    $fname = $data['lawyer_first_name'];
    $lname = $data['lawyer_last_name'];
    $email = $data['lawyer_email'];
    $phone = $data['lawyer_phone_no'];
    $city = $data['lawyer_city'];
    $address = $data['lawyer_address'];
    $rating = $data['lawyer_rating'];
    $special = $data['specialization'];
    $image_type = $data['lawyer_image'];
}
//  $_SESSION["lawyer_id"];
